 ...
 */
public final class PatientHistoryQueryUtils {

    /**
     * Tag for the log messages
     */
    public static final String LOG_TAG = PatientHistoryQueryUtils.class.getName();

    /**
     * Create a private constructor because no one should ever create a {@link PatientHistoryQueryUtils} object.
     * This class is only meant to hold static variables and methods, which can be accessed
     * directly from the class name PatientHistoryQueryUtils (and an object instance of PatientHistoryQueryUtils is not needed).
     */
    private PatientHistoryQueryUtils() {
    }

    /**
     * Query the USGS dataset and return a list of objects.
     */
    public static PatientHistory fetchPatientHistoryData(String requestUrl) {
        // Create URL object
        ...
        PatientHistory patientHistory = extractFeatureFromJson(jsonResponse);
     ...
     */
    private static PatientHistory extractFeatureFromJson(String patientHistoryJSON) {
        // If the JSON string is empty or null, then return early.
        if (TextUtils.isEmpty(patientHistoryJSON)) {
            return null;
        }
        ...
        try {
            ...
            Log.e("PntHistQueryUtils.java", "Problem parsing the JSON results", e);
        }
